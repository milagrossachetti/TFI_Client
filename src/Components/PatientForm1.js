    ...
    return (
        <div className='grid grid-cols-1 gap-2'>
            ...
            <div className='flex flex-row gap-4'>
                    ...
                    <input 
                        className="appearance-none bg-transparent border-b w-full font-montserrat text-main-color focus:outline-none" 
                        type="text" 
                        name='name' 
                        aria-label="Nombre"
                        required></input>
            ...
            <div className='flex flex-row gap-4'>
                    ...
                    <input 
                        className="appearance-none bg-transparent border-b w-full font-montserrat text-main-color focus:outline-none remove-arrow" 
                        type="number" 
                        name='id' 
                        aria-label="DNI"
                        required></input>
